...
public class Telemovel extends Tecnologia implements Interface2{
    ...
    public void verificarHistorico(){
        System.out.println(getNome() + ": Histórico de suporte verificado. Última reparação há 6 meses.");
    }

    //métodos da interface2
    @Override
    public void agendarAtualizacao(){
        System.out.println(getNome() + ": Nova atualização do sistema agendada. Suporte garantido por " + Interface2.Max_Dias_Atualizados + "anos.");
    }

    @Override
    public void iniciarDiagnostico(){
        System.out.println(getNome() + ": Diagnóstico de reparabilidade iniciado. Score " + Interface2.Classificacao_De_Reparacao + "/10.");
    }
