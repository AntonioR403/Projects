...
public class Computador extends Usar implements Interface1, Interface3{
    ...
    public static final int Taxa_de_Contraste = 2000;
    ...
    @Override
    public void solicitarSuporte(String problema){
        System.out.println(getNome() + ": Suporte Solicitador para " + problema + ".");
    }

    @Override
    public void verificarHistorico(){
        System.out.println(getNome() + ": Histórico limpo. Aparelho dentro do prazo de garantia (" + Interface1.Max_dias_Garantia + ").");
    }

    //Métodos da Interface3
    @Override
    public void calibrarCores(){
        System.out.println(getNome() + ": Cores Calibradas. Taxa de Constraste " + Taxa_de_Contraste + ": 1.");
    }

    @Override
    public void testarBrilho(){
        System.out.println(getNome() + ": Brilho e DPD (" + Interface3.Densidade_Pixeis_Padrao + ") testados no monitor.");
    }
}