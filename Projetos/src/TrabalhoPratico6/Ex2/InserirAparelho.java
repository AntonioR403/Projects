...
public class InserirAparelho {
    public static void main(String[] args) {
        ...
        System.out.println("Computador (" + c1.getNome() + ")");

        //chamar métodos da interface1
        c1.solicitarSuporte("Ecrã com pixels mortos");
        c1.verificarHistorico();

        //chamar métodos da interface3
        c1.calibrarCores();
        c1.testarBrilho();

        System.out.println("---------------------------------------");

        System.out.println("Telemovel (" + t1.getNome() + ")");

        //Chamar métodos da interface1
        t1.solicitarSuporte("Problema de Microfone");
        t1.verificarHistorico();
